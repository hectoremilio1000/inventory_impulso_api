...
router
  .group(() => {
    ...
    router.delete('/purchase-orders/:id', [PurchaseOrdersController, 'destroy'])
    router.post('/purchase-orders/:id/items', [PurchaseOrdersController, 'addItem'])
    router.put('/purchase-orders/:id/items/:itemId', [PurchaseOrdersController, 'updateItem'])
    router.delete('/purchase-orders/:id/items/:itemId', [PurchaseOrdersController, 'destroyItem'])
    ...
    router.delete('/stock-requests/:id', [StockRequestsController, 'destroy'])
    router.post('/stock-requests/:id/items', [StockRequestsController, 'addItem'])
    router.put('/stock-requests/:id/items/:itemId', [StockRequestsController, 'updateItem'])
    router.delete('/stock-requests/:id/items/:itemId', [StockRequestsController, 'destroyItem'])
    router.post('/stock-requests/:id/fulfill', [StockRequestsController, 'fulfill'])
